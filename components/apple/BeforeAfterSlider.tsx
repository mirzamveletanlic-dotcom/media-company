  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-1/2 z-10 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white bg-black/70"
        style={{ left: `${position}%` }}
