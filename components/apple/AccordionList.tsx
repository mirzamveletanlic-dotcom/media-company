          ...
          <li key={step.step}>
            ...
            {isOpen && (
              <div
                ...
                className="pb-8 text-body text-near-black"
              >
                <p>
                  <strong>What happens:</strong> {step.happens}
                </p>
                <p className="mt-4">
                  <strong>What we need from you:</strong> {step.need}
                </p>
                <p className="mt-4">
                  <strong>What you get:</strong> {step.get}
                </p>
              </div>
            )}
          </li>
